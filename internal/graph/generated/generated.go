...
type MutationResolver interface {
	...
	DeleteSchool(ctx context.Context, id string) (*model.School, error)
}
...
var sources = []*ast.Source{
	{Name: "internal/graph/schema.graphqls", Input: `type School {
  id: String!
  created_at: String!
  updated_at: String!
  name: String!
...
func (ec *executionContext) field_Mutation_createSchool_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	if tmp, ok := rawArgs["input"]; ok {
		...
		arg0, err = ec.unmarshalNNewSchool2githubᚗcomᚋmoducateᚋheimdallᚋinternalᚋgraphᚋmodelᚐNewSchool(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) field_Mutation_updateSchool_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	if tmp, ok := rawArgs["input"]; ok {
		ctx := graphql.WithPathContext(ctx, graphql.NewPathWithField("input"))
		arg1, err = ec.unmarshalNNewSchool2githubᚗcomᚋmoducateᚋheimdallᚋinternalᚋgraphᚋmodelᚐNewSchool(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) _Mutation_createSchool(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNSchool2ᚖgithubᚗcomᚋmoducateᚋheimdallᚋinternalᚋgraphᚋmodelᚐSchool(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Mutation_updateSchool(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Mutation().UpdateSchool(rctx, args["id"].(string), args["input"].(model.NewSchool))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) _Query_schools(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	res := resTmp.([]*model.School)
	fc.Result = res
	return ec.marshalNSchool2ᚕᚖgithubᚗcomᚋmoducateᚋheimdallᚋinternalᚋgraphᚋmodelᚐSchoolᚄ(ctx, field.Selections, res)
}
...
func (ec *executionContext) unmarshalNNewSchool2githubᚗcomᚋmoducateᚋheimdallᚋinternalᚋgraphᚋmodelᚐNewSchool(ctx context.Context, v interface{}) (model.NewSchool, error) {
	res, err := ec.unmarshalInputNewSchool(ctx, v)
	return res, graphql.ErrorOnPath(ctx, err)
}

func (ec *executionContext) marshalNSchool2githubᚗcomᚋmoducateᚋheimdallᚋinternalᚋgraphᚋmodelᚐSchool(ctx context.Context, sel ast.SelectionSet, v model.School) graphql.Marshaler {
	return ec._School(ctx, sel, &v)
}

func (ec *executionContext) marshalNSchool2ᚕᚖgithubᚗcomᚋmoducateᚋheimdallᚋinternalᚋgraphᚋmodelᚐSchoolᚄ(ctx context.Context, sel ast.SelectionSet, v []*model.School) graphql.Marshaler {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNSchool2ᚖgithubᚗcomᚋmoducateᚋheimdallᚋinternalᚋgraphᚋmodelᚐSchool(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalNSchool2ᚖgithubᚗcomᚋmoducateᚋheimdallᚋinternalᚋgraphᚋmodelᚐSchool(ctx context.Context, sel ast.SelectionSet, v *model.School) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "must not be null")
		}
